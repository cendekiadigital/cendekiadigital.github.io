...
import { FileText, Search, FileSpreadsheet, Lightbulb, ArrowRight, BookOpen, Award, Users, Maximize2, X } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-lg bg-academic-primary/10 flex items-center justify-center shrink-0">
            ...
            <div className="space-y-8">
              <div className="relative group overflow-hidden rounded-[2rem] glass border-white/5">
                <img
                  src="/images/portfolio-review/jurnal.jpeg"
                  alt="Review Artikel Jurnal Process"
                  className="w-full h-auto object-cover"
                />
                <button
                  onClick={() => openImage("/images/portfolio-review/jurnal.jpeg")}
      ...
      <section className="container pb-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            <div className="relative group overflow-hidden rounded-[2rem] glass border-white/5">
              <img
                src="/images/portfolio-review/literature.jpeg"
                alt="Matriks Literature Review"
                className="w-full h-auto object-cover"
              />
              <button
                onClick={() => openImage("/images/portfolio-review/literature.jpeg")}
                className="absolute top-4 right-4 p-3 rounded-lg glass border-white/5 bg-black/50 hover:bg-black/70 transition-colors opacity-0 group-hover:opacity-100"
              >
                <Maximize2 size={16} className="text-white" />
              </button>
