...
const academicServices = [
  ...
  { icon: <BookOpen size={24} />, title: 'Review E-book & Translation', desc: 'Layanan review konten buku elektronik dan penerjemahan profesional.', link: '/portfolio-review-ebook' },
  { icon: <Search size={24} />, title: 'Parafrase AI Text', desc: 'Ubah teks AI menjadi natural, mengalir, dan lolos deteksi plagiasi.', link: '/portfolio-parafrase-ai' },
  { icon: <ShieldCheck size={24} />, title: 'Proofreading', desc: 'Pengecekan ejaan, tata bahasa, dan koherensi naskah secara teliti.', link: '/portfolio-proofreading' },
  { icon: <Files size={24} />, title: 'Formatting Karya Ilmiah', desc: 'Penyesuaian format skripsi, tesis, disertasi, sesuai template jurnal.', link: '/portfolio-formatting' },
  { icon: <GraduationCap size={24} />, title: 'Layanan Akademik Lainnya', desc: 'Bantuan pendampingan riset dan kebutuhan akademik lainnya.', link: '/portfolio-layanan-lainnya' },
];
