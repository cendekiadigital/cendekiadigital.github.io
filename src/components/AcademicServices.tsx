...
const academicServices = [
  ...
  { icon: <BookOpen size={24} />, title: 'Review E-book & Translation', desc: 'Layanan review konten buku elektronik dan penerjemahan profesional.', link: 'https://wa.me/6282245848191' },
  { icon: <Search size={24} />, title: 'Parafrase AI Text', desc: 'Ubah teks AI menjadi natural, mengalir, dan lolos deteksi plagiasi.', link: 'https://wa.me/6282245848191' },
  { icon: <ShieldCheck size={24} />, title: 'Proofreading', desc: 'Pengecekan ejaan, tata bahasa, dan koherensi naskah secara teliti.', link: 'https://wa.me/6282245848191' },
  { icon: <Files size={24} />, title: 'Formatting Karya Ilmiah', desc: 'Penyesuaian format skripsi, tesis, disertasi, sesuai template jurnal.', link: 'https://wa.me/6282245848191' },
  { icon: <GraduationCap size={24} />, title: 'Layanan Akademik Lainnya', desc: 'Bantuan pendampingan riset dan kebutuhan akademik lainnya.', link: 'https://wa.me/6282245848191' },
];
